/**
* Hussein Suleman's AVL Tree
* 2 April 2017
* reference: kukuruku.co/post/avl-trees/
* contains methods to insert items and find items in an AVL tree
* additional code by Holly Judge to count the number of comparison operations
* find and insert operations are counted seperately
* resetInsert and resetFind are used to set the counterFind and counterInsert to 0
*/
